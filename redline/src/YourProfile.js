...
export default function YourProfile(props) {
  ...
  let frog = [];
  let posts2 = posts.filter((brek) => brek.author === props.loggedAs.id);
  ...
  function test(props) {
    ...
    axios
      .patch(
        `https://project-redline-backend.ue.r.appspot.com/Users/${thisGuy[0].id}`,
        {
          screen_name: sname,
          bio: bio,
          profile_pic: pfp,
              ...
              <form>
                <div class="input-group">
                  <input
                    ...
                    placeholder="Change screen name?"
                    defaultValue={thisGuy[0].screen_name}
                    id="sname"
                  ></input>
                </div>
                <br></br>
                ...
                <div class="input-group">
                  <input
                    ...
                    placeholder="Change Profile Pic (only links supported)"
                    defaultValue={thisGuy[0].profile_pic}
                    id="pfp"
                  ></input>
                </div>
                <br></br>
